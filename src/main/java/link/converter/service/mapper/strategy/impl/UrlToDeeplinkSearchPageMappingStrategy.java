...
/**
 * Class implementing URL-to-Deeplink mapping strategy for SEARCH page type
 */
@Component
public class UrlToDeeplinkSearchPageMappingStrategy implements LinkMappingStrategy {
    ...
    public LinkStructureDto map(LinkStructureDto url) {
        ...
        deeplinkQueryParameters.put(QueryParameter.QUERY, url.getQueryParameters().get(QueryParameter.QUERY));
